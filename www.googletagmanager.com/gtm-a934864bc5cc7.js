...
(function() {
    ...
    */
    ...
    ke.Hc = Number("0") || 0;
    ke.ca = "dataLayer";
    ke.Vh = "ChAI8P2EoQYQnpC+jO2hyOxjEiMAZ7Mv4xxejpMpep+/bST71DmDlooNEWuHOpSegDjOG1RBDBoC99w\x3d";
    var ne = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    function Xg() {
        if (!Q(87)) return {};
        try {
            return JSON.parse(Wa("eyIwIjoiVVMiLCIxIjoiVVMtRkwiLCIyIjpmYWxzZSwiMyI6IiIsIjQiOiIiLCI1Ijp0cnVlfQ"))
        } catch (a) {
    ...
    var fj = cj,
        gj = "https://www.googletagmanager.com/a?id=" + S.C + "&cv=10",
        hj = {
            label: S.C + " Container",
            children: [{
    ...
    var tl = function(a, b, c) {
            ...
            z[a.functionName] = d;
            if (a.Vd)
                for (var e = 0; e < a.Vd.length; e++) z[a.Vd[e]] = z[a.Vd[e]] || sl();
        ...
        xl = {
            ...
            Vd: [vl.functionName, ul.functionName],
            Gf: "www.gstatic.com/call-tracking/call-tracking_" + (wl.Sh || wl.Ri) + ".js"
        },
        yl = {},
        zl = function(a, b, c, d) {
            J(22);
    ...
    var Vr = function(a) {
        this.h = function(b) {
            for (var c = [], d = 0; d < a.length; d++) c.push(a[d] === Ec.Pd ? b : a[d]);
            return c.join("")
        }
    };
    ...
    Vr.prototype.valueOf = Vr.prototype.toString;
    Ec.Si = Vr;
    Ec.Ye = {};
    Ec.ij = function(a) {
        return new Vr(a)
    ...
    Ec.Uj = function(a, b, c) {
        a instanceof Ec.Si && (a = a.h(Ec.kk(b, c)), b = oa);
        return {
            Cj: a,
            R: b
        }
    ...
    var Xr = function(a, b, c) {
        ...
        Yr = function(a) {
            le.hasOwnProperty("autoEventsSettings") || (le.autoEventsSettings = {});
    ...
    var Fv = function(a, b) {
                ...
                var d = !Uh(N.g.O),
                    e = function(f) {
                        ...
                        if (c.F || Jv(b, n.createOnlyFields)) {
                            c.F && (g = "gtm" + Fe(), k = n.createOnlyFields, n.gtmTrackerName && (k.name = g));
                            m(function() {
                                var t = m.getByName(b);
                                t && (p = t.get("clientId"));
                                c.F || m.remove(b)
                            ...
                            d &&
                                Uh(N.g.O) && (d = !1, m(function() {
                                    var t = pp().getByName(c.F ? g : b);
                                    if (t) {
                                        var u = t.get("clientId"),
                                            v = Q(90) ? "sst.gcut" : "gcut";
                                        u == p && q || (c.F ? (n.fieldsToSet["&gcu"] = "1", n.fieldsToSet["&" + v] = he[f]) : (n.fieldsToSend["&gcu"] = "1", n.fieldsToSend["&" + v] = he[f]), t.set(n.fieldsToSet), c.F ? t.send("pageview") : t.send("pageview", n.fieldsToSend))
                                    }
                                }));
                            c.F && m(function() {
                                m.remove(g)
        ...
        Uv = function(a,
                ...
                k(function() {
                    if (!c.F && Yb(E)) {
                        var K = u.fieldsToSend,
                            ...
                            V;
                        for (V in E)
                            if (E.hasOwnProperty(V) && /^(dimension|metric)\d+$/.test(V) && void 0 != E[V]) {
                                var fa = M.get(Ev(E[V]));
                                Mv(K, V, fa)
                            }
                    }
            ...
            var f = a,
                ...
                k = c.F ? rp(R(c, "gaFunctionName")) : rp();
            if (pa(k)) {
                var m = pp,
                    n;
                c.F ? n = R(c, "name") ||
                ...
                var p = function(E) {
                    ...
                    q = function(E) {
                        var K = function(ca, Z) {
                                for (var W = 0; Z && W < Z.length; W++) p(ca, Z[W])
                            },
                            M = c.F,
                            V = M ? Nv(u) : Ov(b, c);
                        if (V) {
                            ...
                            var L = V.action;
                            if (M || "impressions" === L)
                                if (K("ec:addImpression", V.sh), !M) return;
                ...
                if (u.createOnlyFields[N.g.vb] && !c.F) {
                    var w = te || ve ? Ho(u.createOnlyFields[N.g.vb], "/analytics.js") : void 0;
                    w && (g = w)
                }
                var y = c.F ? u.fieldsToSet[N.g.vb] : u.createOnlyFields[N.g.vb];
                if (y) {
                    var x = c.F ? u.fieldsToSet[N.g.Fd] : u.createOnlyFields[N.g.Fd];
                    x && !Rv[n] && (Rv[n] = !0, k(vp(n, x)))
                }
                c.F ? u.enableRecaptcha && p("require", "recaptcha", "recaptcha.js") :
                ...
                else b === N.g.oa ? (t(), Cl(f, c), R(c, N.g.kb) && (dl(["aw", "dc"]), sp(n + ".")), 0 !=
            ...
            function b(e) {
                ...
                (function() {
                    if (e.category) g.category = e.category;
                        ...
                        for (var k = "", m = 0; m <
                            Wv.length; m++) void 0 !== e[Wv[m]] && (k && (k += "/"), k += e[Wv[m]]);
                        k && (g.category = k)
                    }
                })();
    ...
    var Tv, Rv = {},
        Hv = {},
        $v = {},
        aw = Object.freeze(($v.page_hostname =
            1, $v[N.g.W] = 1, $v[N.g.fb] = 1, $v[N.g.Ra] = 1, $v[N.g.Fa] = 1, $v[N.g.Sa] = 1, $v[N.g.Mb] = 1, $v[N.g.xd] = 1, $v[N.g.Ka] = 1, $v[N.g.ub] = 1, $v[N.g.sa] = 1, $v[N.g.Sb] = 1, $v[N.g.za] = 1, $v[N.g.xb] = 1, $v)),
        bw = {},
        Cv = Object.freeze((bw.client_storage = "storage", bw.sample_rate = 1, bw.site_speed_sample_rate = 1, bw.store_gac = 1, bw.use_amp_client_id = 1, bw[N.g.hb] = 1, bw[N.g.qa] = "storeGac", bw[N.g.Ra] = 1, bw[N.g.Fa] = 1, bw[N.g.Sa] = 1, bw[N.g.Mb] = 1, bw[N.g.xd] = 1, bw[N.g.ub] = 1, bw)),
        cw = {},
        dw = Object.freeze((cw._cs = 1, cw._useUp = 1, cw.allowAnchor = 1, cw.allowLinker =
        ...
        gw = {},
        hw = Object.freeze((gw.content_id = 1, gw.event_action = 1, gw.event_category = 1, gw.event_label = 1, gw.link_attribution = 1, gw.name = 1, gw[N.g.ra] = 1, gw[N.g.pg] = 1, gw[N.g.Ga] =
            1, gw[N.g.ja] = 1, gw)),
        iw = Object.freeze({
            displayfeatures: 1,
            enableLinkId: 1,
        ...
        jw = {},
        Pv = Object.freeze((jw.levels = 1, jw[N.g.Fa] = "duration", jw[N.g.Mb] = 1, jw)),
        kw = {},
        lw = Object.freeze((kw.anonymize_ip =
            1, kw.fatal = 1, kw.send_page_view = 1, kw.store_gac = 1, kw.use_amp_client_id = 1, kw[N.g.qa] = 1, kw[N.g.qg] = 1, kw)),
        Qv = function(a, b, c, d) {
            if (void 0 !== c)
                if (lw[b] && (c = Ba(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[Ev(b)] = c;
                else if (h(a)) d[a] = c;
            else
        ...
        mw = {},
        Sv = Object.freeze((mw.checkout_progress = 1, mw.select_content = 1, mw.set_checkout_option = 1, mw[N.g.ic] = 1, mw[N.g.jc] =
            1, mw[N.g.Jb] = 1, mw[N.g.kc] = 1, mw[N.g.rb] = 1, mw[N.g.Kb] = 1, mw[N.g.sb] = 1, mw[N.g.Ba] = 1, mw[N.g.mc] = 1, mw[N.g.Ca] = 1, mw)),
        nw = {},
        ow = Object.freeze((nw.checkout_progress = 1, nw.set_checkout_option = 1, nw[N.g.Uf] = 1, nw[N.g.Vf] = 1, nw[N.g.ic] = 1, nw[N.g.jc] = 1, nw[N.g.Wf] = 1, nw[N.g.Jb] = 1, nw[N.g.Ba] = 1, nw[N.g.mc] = 1, nw[N.g.Xf] = 1, nw)),
        pw = {},
        qw = Object.freeze((pw.generate_lead = 1, pw.login = 1, pw.search = 1, pw.select_content = 1, pw.share = 1, pw.sign_up = 1, pw.view_search_results = 1, pw[N.g.kc] = 1, pw[N.g.rb] = 1, pw[N.g.Kb] = 1, pw[N.g.sb] = 1, pw[N.g.Ca] =
            1, pw)),
        rw = function(a) {
            var b = "general";
            ow[a] ? b = "ecommerce" : qw[a] ? b = "engagement" : "exception" === a && (b = "error");
            return b
        },
        sw = {},
        tw = Object.freeze((sw.view_search_results = 1, sw[N.g.rb] = 1, sw[N.g.sb] = 1, sw[N.g.Ca] = 1, sw)),
        Mv = function(a, b, c) {
        ...
        Iv = function(a, b, c) {
            ...
            for (var r = !c.F, t = am(c), u = 0; u < t.length; ++u) {
                var v = t[u];
                if (c.F) {
                    var w = d(v);
                    iw.hasOwnProperty(v) ? e[v] = w : dw.hasOwnProperty(v) ? k[v] = w : g[v] = w
                } else {
                    var y = void 0;
                    y = v !== N.g.Z ? d(v) : bm(c, v);
                    if (hw.hasOwnProperty(v)) Qv(hw[v], v,
                        y, e);
                    else if (ew.hasOwnProperty(v)) Qv(ew[v], v, y, g);
                    else if (Dv.hasOwnProperty(v)) Qv(Dv[v], v, y, f);
                    else if (Cv.hasOwnProperty(v)) Qv(Cv[v], v, y, k);
                    else if (/^(dimension|metric|content_group)\d+$/.test(v)) Qv(1, v, y, f);
                    else if (v === N.g.Z) {
                        if (!Zv) {
                            var x = Oa(y);
                            x && (f["&did"] = x)
                        ...
                        var B = void 0,
                            A = void 0;
                        b === N.g.oa ? B = Oa(bm(c, v), ".") : (B = Oa(bm(c, v, 1), "."), A = Oa(bm(c, v, 2), "."));
                        B && (f["&gdid"] = B);
                        A && (f["&edid"] = A)
                    } else v === N.g.Ka && 0 > t.indexOf(N.g.Mb) && (k.cookieName = y + "_ga");
                    Q(96) && aw[v] && (c.m.hasOwnProperty(v) || b === N.g.oa &&
                        c.h.hasOwnProperty(v)) && (r = !1)
                }
            }
            Q(96) && r && (f["&jsscut"] = "1");
            !1 !== d(N.g.gi) && !1 !== d(N.g.fb) && du() || (g.allowAdFeatures = !1);
            !1 !== d(N.g.W) && eu() || (g.allowAdPersonalizationSignals = !1);
            !c.F && d(N.g.kb) && (k._useUp = !0);
            if (c.F) {
                ...
                "login" === b || "sign_up" === b || "share" === b ? Mv(e, "eventLabel", d(N.g.pg)) : "search" ===
                    b || "view_search_results" === b ? Mv(e, "eventLabel", d(N.g.Bi)) : "select_content" === b && Mv(e, "eventLabel", d(N.g.ji));
                var H = e[N.g.ra] || {},
                    I = H[N.g.Qb];
                I || 0 != I && H[N.g.N] ? k.allowLinker = !0 : !1 === I && Mv(k, "useAmpClientId", !1);
                f.hitCallback = c.R;
                k.name = a
            }
            lf() && (g["&gcs"] = Vh(), Uh(N.g.O) || (k.storage = "none"), Uh(N.g.H) || (g.allowAdFeatures = !1, k.storeGac = !1));
            var E = d(N.g.ma) || d(N.g.vb),
                K = d(N.g.Fd);
            E && (c.F || (k[N.g.vb] = E), k._cd2l = !0);
            K && !c.F && (k[N.g.Fd] = K);
            e.fieldsToSend = f;
            e.fieldsToSet = g;
        ...
        function(a) {
            ...
            if (b.impressions) {
                ...
                var d = b.impressions;
                c.sh = "impressions" === b.translateIfKeyEquals ? Xv(d) : d
            }
            if (b.promoView) {
                c.action = "promo_view";
                var e = b.promoView.promotions;
                c.Wc = "promoView" === b.translateIfKeyEquals ? Xv(e) : e
            }
            if (b.promoClick) {
                c.action = "promo_click";
                var f = b.promoClick.promotions;
                c.Wc = "promoClick" === b.translateIfKeyEquals ? Xv(f) : f;
            ...
            for (var g in b)
                if (b.hasOwnProperty(g) &&
                    ...
                    c.action = g;
                    var k = b[g].products;
                    c.Db = "products" === b.translateIfKeyEquals ? Xv(k) : k;
        ...
        Ov = function(a, b) {
            function c(u) {
                return {
                    id: d(N.g.Ma),
                    affiliation: d(N.g.oi),
                    revenue: d(N.g.ja),
                    tax: d(N.g.cg),
                    shipping: d(N.g.zd),
                    coupon: d(N.g.ri),
                    list: d(N.g.ze) || d(N.g.ye) || u
                }
            }
            for (var d = function(u) {
                    return R(b, u)
                }, e = d(N.g.ba), f, g = 0; e && g < e.length && !(f = e[g][N.g.ze] ||
                    e[g][N.g.ye]); g++);
            var k = d(N.g.vc);
            if (Yb(k))
            ...
            else if ("select_content" === a && r && 0 < r.length || a === N.g.Kb) q = {
                action: "promo_click",
                Wc: Xv(r) || Xv(e)
            };
            else if ("select_content" === a || a === N.g.kc) q = {
                action: "click",
                Oa: {
            ...
            else if (a === N.g.Jb || "checkout_progress" === a) {
                var t = {
                    step: a === N.g.Jb ? 1 : d(N.g.ag),
                    option: d(N.g.Zf)
                };
                q = {
                    action: "checkout",
    ...
    Y.o.f = ["google"],
        function() {
            (function(a) {
                ...
                var b = As("gtm.referrer", 1) || D.referrer;
                return b ? a.vtp_component && "URL" != a.vtp_component ? wf(yf(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : zs(String(b)) : String(b)
            })
        }();
    Y.o.cl = ["google"],
        function() {
    ...
    Y.o.u = ["google"],
        function() {
            ...
            (function(b) {
                ...
                var c;
                c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : As("gtm.url", 1)) || xs();
                var d = b[a("vtp_component")];
                if (!d || "URL" == d) return zs(String(c));
                var e = yf(String(c)),
                    f;
                if ("QUERY" === d) a: {
    ...
    Y.o.v = ["google"],
        function() {
            (function(a) {
                ...
                var c = As(b.replace(/\\\./g, "."), a.vtp_dataLayerVersion || 1),
        ...
        function() {
            ...
            function g(r) {
                if ("form" === r.tagName.toLowerCase() && r.elements) {
                    for (var t = 0, u = 0; u < r.elements.length; u++) ds(r.elements[u]) && t++;
                    return t
                }
            }
                        ...
                        a: {
                            ...
                            switch (C) {
                                ...
                                case "IS_OUTBOUND":
                                    ...
                                    break a;
                                default:
                                    x = wf(A, C, r.vtp_stripWww, r.vtp_defaultPages, r.vtp_queryKey)
                            }
                        }
                        return x;
                    case "ATTRIBUTE":
                        ...
                        if (void 0 === r.vtp_attribute) H = b(w,
                            ...
                            var I = w.element;
                            H = I && Nb(I, r.vtp_attribute) || u || ""
                        }
                        return H;
                    case "MD":
                        var E = r.vtp_mdValue,
                            K = a(w, t, "MD", ps);
                        return E && K ? ss(K, E) || u : K || u;
                    case "FORM":
                        return e(String(r.vtp_component || "SUBMIT_TEXT"), w, t, u);
                    default:
                        var M = b(w, v, u);
                        Is(M, "aev", r.vtp_gtmEventId);
                        return M
                }
            })
        }();
    ...
    Y.o.ua = ["google"],
        function() {
            ...
            function b(m) {
                var n = {};
                m.vtp_gaSettings && G(Bw(m.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), n);
                G(Bw(m.vtp_fieldsToSet, "fieldName", "value"), n);
            ...
            function d(m, n, p) {
                var q =
                    ...
                    t = {},
                    u = (t[N.g.kc] = "click", t[N.g.Ca] = "detail", t[N.g.ic] = "add", t[N.g.jc] = "remove", t[N.g.Jb] = "checkout", t[N.g.Ba] = "purchase", t[N.g.mc] = "refund", t),
                    v;
                ...
                if (m.vtp_useGA4SchemaForEcommerce) {
                    if (p === N.g.rb && !v.impressions) v.items && (y.impressions = v.items, y.translateIfKeyEquals = "impressions");
                    else if (p === N.g.sb && !v.promoView) v.promoView = {}, v.items && (y.promoView = {}, y.promoView.promotions = v.items, y.translateIfKeyEquals = "promoView");
                    else if (p === N.g.Kb && !v.promoClick) v.promoClick = {}, v.items && (y.promoClick = {}, y.promoClick.promotions = v.items, y.translateIfKeyEquals = "promoClick", q(v, "promoClick",
                        y));
                ...
                m.vtp_useGA4SchemaForEcommerce && u.hasOwnProperty(p) && q(v, u[p], y);
                return y;
            }
            ...
            function e(m, n) {
                if (!f) {
                    ...
                    var q = m.vtp_gtmOnFailure,
                        r = te || ve ? Ho(n._x_19, "/analytics.js") : void 0,
                        t = rl("https:", "http:", "//www.google-analytics.com/" + p, n && !!n.forceSSL);
                    T("analytics.js" === p && r ? r : t, function() {
                        var u = pp();
                        u && u.loaded || q();
                    }, q)
                }
            ...
            (function(m) {
                ...
                if (m.vtp_gaSettings) {
                    ...
                    G(Bw(t.vtp_contentGroup, "index", "group"), p);
                    G(Bw(t.vtp_dimension, "index", "dimension"), q);
                    G(Bw(t.vtp_metric, "index", "metric"), r);
                    var u = G(t);
                ...
                G(Bw(m.vtp_contentGroup, "index", "group"), p);
                G(Bw(m.vtp_dimension, "index", "dimension"), q);
                G(Bw(m.vtp_metric, "index", "metric"), r);
                var v = b(m),
                ...
                m.vtp_setTrackerName &&
                    "string" == typeof m.vtp_trackerName ? "" !== m.vtp_trackerName && (B = m.vtp_trackerName, x = B + ".") : (B = "gtm" + Fe(), x = B + ".");
                var A = function(Z, W) {
                    for (var va in W) W.hasOwnProperty(va) && (v[Z + va] = W[va])
                };
                A("contentGroup", p);
                A("dimension", q);
                A("metric", r);
                ...
                if ("TRACK_EVENT" === m.vtp_trackType) y = "track_event", n(), v.eventCategory = String(m.vtp_eventCategory), v.eventAction = String(m.vtp_eventAction), v.eventLabel = c(String, m.vtp_eventLabel), v.value =
                    ...
                    if (y = N.g.nc, n(), "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == m.vtp_advertisingFeaturesType && (v.remarketingLists = !0), m.vtp_autoLinkDomains) {
                        var C = {};
                        C[N.g.N] = m.vtp_autoLinkDomains;
                        C.use_anchor = m.vtp_useHashAutoLink;
                        C[N.g.wb] = m.vtp_decorateFormsAutoLink;
                        v[N.g.ra] = C
                    }
            ...
            function b(d) {
                if (D.body) {
                    var e = d.vtp_gtmOnFailure,
                        f = Js(d.vtp_html, d.vtp_gtmOnSuccess, e),
                        g = f.Cj,
                        k = f.R;
    ...
    var Tx = {};
    Tx.macro = function(a) {
        if (Ec.Ye.hasOwnProperty(a)) return Ec.Ye[a]
    }, Tx.onHtmlSuccess = Ec.kh(!0), Tx.onHtmlFailure = Ec.kh(!1);
    Tx.dataLayer = Me;
