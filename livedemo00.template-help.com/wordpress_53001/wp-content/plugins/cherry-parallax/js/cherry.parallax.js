    ...
    function ParallaxBox() {
        ...
        function parallaxBox(obj) {
            var obj_bg = obj.find('.parallax-bg'),
                ...
                obj_bg_inner, img, originalWidth = 0,
                originalHeight = 0,
            ...
            function loadVimeoVideo() {
                ...
                function vimeoRady() {
                    var vimeo_id = obj_bg_inner.data('vimeo-id'),
                        vimeo_iframe, vimeo_player, vimeo_player_playstarted = false;
            ...
            function parallaxMove() {
                if (parallax && !liteMode) {
                    ...
                    if ((startScrollTop > objOffsetTop) && (endScrollTop < objOffsetTop)) {
                        ...
                        obj_bg_inner.css({
                            "transform": "translate3d(0px, " + newPositionTop + "px, 0px)"
                        });
                    }
                }
            }
        ...
        function objectResize(obj, baseWidth, baseHeight, originalWidth, originalHeight) {
            var imageRatio, originalWidth, originalHeight, newImgWidth, newImgHeight, newImgTop, newImgLeft;
